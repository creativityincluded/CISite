...
class Cart66ProCommon {
  ...
  public static function getCaPostServices() {
    $caServices = array(
      'Canada Post Priority Courier' => 'Priority Courier',
      'Canada Post XpressPost' => 'Xpresspost',
      'Canada Post Expedited' => 'Expedited',
      'Canada Post Regular' => 'Regular'
    );
  ...
  public static function getCaPostIntlServices() {
    $internationalServices = array(
      'Canada Post Priority Worldwide INTL' => 'Priority Worldwide INTL',
      'Canada Post Priority Worldwide USA' => 'Priority Worldwide USA',
      'Canada Post XPressPost International' => 'XPressPost International',
      'Canada Post XpressPost USA' => 'Xpresspost USA',
      'Canada Post Parcel Surface' => 'Parcel Surface',
      'Canada Post Parcel Air' => 'Parcel Air',
      'Canada Post Expedited US Business' => 'Expedited US Business',
      'Canada Post Small Packets Air' => 'Small Packets Air',
      'Canada Post Small Packets Surface' => 'Small Packets Surface'
    );
